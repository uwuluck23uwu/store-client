...
import { useCreateCategoryMutation } from "../../api/productApi";
...
const CreateCategoryScreen = ({ navigation }: any) => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      Alert.alert(
        "เกิดข้อผิดพลาด",
        error?.data?.message || "ไม่สามารถเพิ่มหมวดหมู่ได้"
      );
    }
  };
      ...
      <ScrollView contentContainerStyle={styles.content}>
        ...
        <View style={styles.section}>
          ...
          <TextInput
            ...
            placeholder="กรอกรายละเอียดหมวดหมู่ เช่น น้ำผลไม้ ของว่าง เครื่องดื่ม"
            placeholderTextColor="#999"
            multiline
            numberOfLines={4}
